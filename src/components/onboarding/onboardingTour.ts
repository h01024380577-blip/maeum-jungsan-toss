...
export const ONBOARDING_TOUR_STEPS: OnboardingTourStep[] = [
  ...
  },
  {
    step: 2,
    targetId: 'input-card',
    pulseTargetId: 'ai-analyze-button',
    title: '청첩장 또는 부고장 URL을 붙여넣어요',
    body: '링크를 붙여넣고 분석 버튼을 눌러요.',
    action: 'analyze',
    placement: 'bottom',
  },
  {
    step: 3,
    targetId: 'result-info',
    title: '내용을 먼저 확인해요',
  ...
  },
  {
    ...
    action: 'transfer',
    actionLabel: '송금 방법 보기',
    placement: 'top',
  },
  {
    step: 5,
    targetId: 'toss-transfer-button',
    pulseTargetId: 'toss-transfer-button',
    title: '토스로 송금할 수 있어요',
    body: '마음만 전할 경우, 토스로 송금할 수 있어요.',
    action: 'history',
    actionLabel: '내역에서 확인하기',
    placement: 'top',
  },
  {
    step: 6,
